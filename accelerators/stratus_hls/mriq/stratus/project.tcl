...
set INPUT_PATH "../dataset/input"
set OUTPUT_PATH "../dataset/output"
set DATA_4_TEST "../dataset"
# TESTBENCHES can be set as the following: 
# "32_32_32_dataset",  "64_64_64_dataset",  "128_128_128_dataset", "test"
set TESTBENCHES "test"
...
foreach dma [list 64] {
	...
	foreach para [list 4 8 16] {
		...
		append ARGV "$DATA_4_TEST/$tb\_in.h ";

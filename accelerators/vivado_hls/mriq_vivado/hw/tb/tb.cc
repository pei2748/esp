...
int main(int argc, char **argv) {
    ...
    in_words_adj = round_up(5*numK+3*numX, VALUES_PER_WORD);
    ...
    std::string inputName = "/home/esp2020/pl2748/esp/accelerators/vivado_hls/mriq_vivado/hw/tb/test_small.bin";
    std::string goldName = "/home/esp2020/pl2748/esp/accelerators/vivado_hls/mriq_vivado/hw/tb/test_small.out";
    std::string data4barec = "/home/esp2020/pl2748/esp/accelerators/vivado_hls/mriq_vivado/hw/tb/test_barec.h";
